...
final class ProcessEventMigratedApplier
  ...
  public ProcessEventMigratedApplier(final MutableEventScopeInstanceState eventScopeState) {
    this.eventScopeState = eventScopeState;
  }

  @Override
  public void applyState(final long key, final ProcessEventRecord value) {
    final long scopeKey = value.getScopeKey();
    eventScopeState.updateTrigger(
        scopeKey,
        key,
        (eventTrigger) -> eventTrigger.setElementId(value.getTargetElementIdBuffer()));
  }
}
