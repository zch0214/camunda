...
class DynamicClusterManagementWithRaftTest {

  @TempDir Path tempDirectory;
  private DynamicClusterAwareNodeWithRaft node0;
  private DynamicClusterAwareNodeWithRaft node1;
  private DynamicClusterAwareNodeWithRaft node2;
  ...
  void setup() {
    ...
    node1 =
        new DynamicClusterAwareNodeWithRaft(
            MemberId.from("1"),
            null,
            tempDirectory.resolve("1/config"),
            tempDirectory.resolve("1/system-raft/"),
            createClusterNode(clusterNodes.get(1), clusterNodes));
    node2 =
        new DynamicClusterAwareNodeWithRaft(
            MemberId.from("2"),
            null,
            tempDirectory.resolve("2/config"),
            tempDirectory.resolve("2/system-raft"),
